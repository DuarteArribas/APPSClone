...
class RinexHeader:
  ...
  ALLOWED_VERSIONS        : list
    The allowed RINEX versions. ALL is included to represent mandatory headers to all versions
  ...
  def __fillHeaderData(self,headerLabel,line):
    ...
    ----------
    headerLabel : str
      The header label to fill with the respective data
    line        : str
      The current line
    """
  ...
  def isValidHeader(self):
    ...
    Returns
    ----------
    tuple(bool,tuple(enum,str))
      The bool is True if the header is valid and False otherwise
      The enum is the message, which indicates why the header is not valid
      The string is the string that denotes what went wrong or `OK` if nothing is wrong with the header
    """
  ...
  def __isValidNumberOfHeaders(self):
    ...
    ----------
    tuple(bool,str)
      The bool is True if the number of headers read is equal to the number of needed headers or False otherwise
      The string is the first header that is missing from the header
    """
  ...
  def __isValidReceiver(self):
    ...
    ----------
    tuple(bool,str)
      The bool is True if the receiver is in the valid receivers set or False otherwise
      The string is the receiver being tested
    """
  ...
  def __isValidAntenna(self):
    ...
    ----------
    tuple(bool,str)
      The bool is True if the antenna is in the valid antennas set or False otherwise
      The string is the antenna being tested
    """
  ...
  def __extractIntUntilChar(self,string):
    ...
    tuple(integer,integer)
      The number before the first char
  ...
  @staticmethod
  def validityErrorToString(validityError,errorArg):
    ...
    validityError : enum
      The validity error
    errorArg      : str
      The argument of the error. E.G.: if the error is invalid receiver, errorArg will be the name of that receiver
